...
import exportPrivateKeyJwk from '../utils/crypto/exportPrivateKeyJwk';
// import exportPublicKeyBase64 from '../utils/crypto/exportPublicKeyBase64';
import exportPublicKeyJwk from '../utils/crypto/exportPublicKeyJwk';
...
const ResearchJwk = () => {
  ...
  useEffect(() => {
    (async () => {
      ...
      const privateKeyBase64 = await exportPrivateKeyJwk(kp);
      const publicKeyBase64 = await exportPublicKeyJwk(kp);
